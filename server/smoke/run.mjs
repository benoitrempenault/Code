...
const PARCOURS = ["suppression", "anniversaires", "suivi", "fiche-adresse", "compte"];
...
const apiProc = spawn(process.execPath, ["node.js"], {
  ...
  env: { ...process.env, PORT: String(PORT_API), DB_PATH: dbPath, DEV_MODE: "1", ADMIN_KEY: "dev-admin",
    APP_ORIGINS: "http://localhost:" + PORT_SITE, BAN_BASE: "http://localhost:" + PORT_BAN, DVF_BASE: "http://localhost:1" },
});
let journalApi = "";
