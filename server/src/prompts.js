...
const FICHE_SYSTEM = [
  ...
  "6. « Menuiseries : » type d'huisseries, vitrage, volets, moustiquaires.",
  "7. « Assainissement : » tout-à-l'égout, fosse septique, conformité si précisée.",
  "8. « Façade : » façade/crépi, avant-toits, gouttières, descentes, bandeaux (n'emploie JAMAIS le mot « enveloppe »).",
